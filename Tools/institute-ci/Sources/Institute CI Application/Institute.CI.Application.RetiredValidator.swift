...
/// here in favour of `CI.Validation.Harness` — its Swift owner since
/// C0.
///
...
extension Institute.CI.Application {
    public enum RetiredValidator {
        ...
        public static let scripts: [String: String] = [
            ...
            "ci-010": "validate-ci-matrix.py",
            "ci-021": "validate-embedded-job.py",
            "ci-030": "validate-thin-callers.py",
            "ci-032": "validate-visibility-gate.py",
            ...
            "ci-099": "validate-ci-matrix.py",
            "ci-100": "validate-swiftlint-rules.py",
            "ci-102": "validate-composite-action-descriptions.py",
            "ci-103": "validate-env-context.py",
            "ci-manifest-binding": "validate-manifest-binding.py",
            "doc-020": "validate-docc-structure.py",
            "gh-ignore-001": "validate-gitignore.py",
            "gh-ignore-002": "validate-gitignore.py",
            ...
            "readme-008": "validate-readme.py",
            "readme-013": "validate-readme.py",
            "readme-017": "validate-readme.py",
            "readme-026": "validate-readme.py",
            "skill-corpus-empty": "validate-skill-hygiene.py",
            "skill-frontmatter": "validate-skill-hygiene.py",
            "skill-identity": "validate-skill-hygiene.py",
            "skill-internal-rule-id": "validate-skill-hygiene.py",
            "skill-links": "validate-skill-hygiene.py",
            "skill-machine-path": "validate-skill-hygiene.py",
            "skill-unsanctioned-reference": "validate-skill-hygiene.py",
...
extension Institute.CI.Application.RetiredValidator {
    ...
    /// `CI Validation`: a validator is a pure question by contract, and
