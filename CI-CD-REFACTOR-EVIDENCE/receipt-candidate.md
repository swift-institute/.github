...
> **Phase: pre-finalization candidate (R29).** This document freezes the
> receipt candidate; it is not yet the §6.3 receipt and must not be
> presented as one until R1's post-action final commit.
...
- Completed: 2026-08-05 (candidate freeze; R1 pending)
...
|---|---|---|---|---|---|
| Programme Goal | swift-institute/.github#276 | — | programme-wide | open (closure is R1's performative act; candidate phase) | — |
